...
export const CityData = [
  ...
  { name: "Bridgeport", lat: 41.1918, long: -73.1954, div: "S" },
  ...
  { name: "Lehigh Valley", lat: 40.5961, long: -75.4756, div: "T" },
  ...
  { name: "Coachella Valley", lat: 33.8239, long: -116.5117, div: "T" },
  { name: "Jackson", lat: 32.3157, long: -90.2125, div: "T" },
