...
const CityData = [
  ...
  { name: "Bakersfield", lat: 35.3529, long: -119.036, div: "BW" },
  ...
  { name: "Jacksonville", lat: 30.3322, long: -81.6749, div: "BS" },
  { name: "Providence", lat: 41.823, long: -71.4187, div: "BE" },
  ...
  { name: "Sarasota", lat: 27.3377, long: -82.5393, div: "BS" },
  ...
  { name: "Baton Rouge", lat: 30.442, long: -91.1311, div: "BS" },
  { name: "Albany", lat: 42.6664, long: -73.7987, div: "BE" },
      ...
      <MarkerContent>
        <div
          className={cn("size-3 rounded-full border border-gray-400 bg-white", {
            ...
            "bg-purple-600": division === "BW",
            "bg-orange-500": division === "BN",
            "bg-green-800": division === "BS",
            "bg-teal-700": division === "BE",
            "bg-black": division === "T",
          })}
        ></div>
