...
function DefaultLoader() {
  return (
    <div className="backdrop-blur-xs absolute inset-0 z-10 flex items-center justify-center bg-background/50">
...
function PopupCloseButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      ...
      className="absolute right-0.5 top-0.5 z-10 inline-flex size-5 cursor-pointer items-center justify-center rounded-sm text-foreground transition-colors hover:bg-muted focus:outline-none focus-visible:ring-2 focus-visible:ring-ring"
    >
...
function MarkerTooltip({
  ...
  return createPortal(
    <div
      className={cn(
        "pointer-events-none text-balance rounded-md bg-foreground px-2 py-1 text-xs text-background shadow-md",
        "duration-200 ease-out animate-in fade-in-0 zoom-in-95",
        className
      )}
    >
