import { driverCodes, constructorNames, driverToConstructor, calculatePoints, constructorToDrivers } from "~/data/F1/2023/F1data23";
import type { DriverCodeType, ConstructorNameType } from "~/data/F1/2023/F1data23";
