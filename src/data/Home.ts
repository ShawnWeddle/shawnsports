export const allNavHeads = {"Home": ["Home",], "NBA": ["Future Picks", "Lottery", "Finals", "Rank",], "NFL": ["Schedule", "Super Bowls", "Rank"], "F1": ["Tables", "Standings", "Compare", "Rank"], "MLB": ["World Series", "Rank", ], "NHL": ["Stanley Cups", "Rank"], "WNBA": ["Rank", ]} as const;
